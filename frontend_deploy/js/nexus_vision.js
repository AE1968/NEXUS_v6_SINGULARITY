        ...
        if (detections.length > 0) {
            ...
            if (confidence > 0.5) {
                ...
                if (window.NexusBioMatrix) {
                    if (emotion === 'happy') window.NexusBioMatrix.stimulate('reward');
                    if (emotion === 'surprised') window.NexusBioMatrix.stimulate('surprise');
                    if (emotion === 'angry' || emotion === 'sad') window.NexusBioMatrix.stimulate('punishment');
                }
            }
        }
    },
